...
public class SymbolTable {
	...
	static {
		...
		globals.put("input", new PaperProtoTuple());
	...
	private static void importLibs(final List<URL> urls) throws IOException {
		...
		final Class<?>[] builtinFuncs = {
			...
			boa.functions.nlp.BoaNLPSentence.class,
			boa.functions.nlp.BoaNLPStemmer.class,
			boa.functions.nlp.BoaNLPTokenizer.class
		};
